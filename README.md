...
Each one-line announcement names the player, the newly queued amount, and the total Solar Satellites already built or queued. Players without a display name use a shortened wallet address.
